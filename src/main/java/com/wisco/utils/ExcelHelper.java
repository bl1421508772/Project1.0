...
public class ExcelHelper {
     ...
     * @param response
     */
    public static void exportExcel(List<String> headers, List<Object[]> bodyContent, String fileName,
        ...
        try {
            ...
            response.setHeader("Content-disposition",
                    "inline;filename = " + java.net.URLEncoder.encode(fileName, "UTF-8") + ".xls");
     ...
     * @param lists
     */
    private static void createExcelHeader(HSSFWorkbook workbook, HSSFSheet sheet, List<String> lists) {
     ...
     * @param list
     */
    private static void createExcelBody(HSSFWorkbook workbook, HSSFSheet sheet, List<Object[]> list) {
        // 定义单元格样式
        HSSFCellStyle cellStyle = workbook.createCellStyle();
